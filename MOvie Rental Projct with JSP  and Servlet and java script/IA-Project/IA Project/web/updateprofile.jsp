...
<html>
    ...
    <body>
       <% 
        ...
        String userKey = request.getSession().getAttribute("user").toString();
        ...
        ResultSet RS = null;
           ...
           st.executeUpdate ("UPDATE `movierental`.`user` SET `Username` = '"+username+"' , `Pass` = '"+pass+"'   WHERE `Username` = '"+userKey+"'");
