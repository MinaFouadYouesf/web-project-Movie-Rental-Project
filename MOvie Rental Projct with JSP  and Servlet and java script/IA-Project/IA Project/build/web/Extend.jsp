...
<html>
    ...
    <body>
        ...
        <%
            try {
                ...
                String newReturnDate=request.getParameter("extend");
  ...
  //st.executeUpdate ("UPDATE `movierental`.`rentedmovies` SET `ReturnDate` = '"+newReturnDate+"'   WHERE `Username` = '"+userName+"'");
   st.executeUpdate ("UPDATE `movierental`.`rentedmovies` SET `ReturnDate` = '"+newReturnDate+"'   WHERE `Username` = '"+userName+"' and  `MovieName` = '"+movieName+"' ");
